    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-12">
      <div className="flex flex-col items-center text-center max-w-sm mx-auto">
        <div className="w-16 h-16 bg-slate-100 rounded-2xl flex items-center justify-center mb-4">
          <Megaphone size={30} className="text-slate-400" />
        </div>
        <h3 className="text-lg font-semibold text-slate-900">No Advertisements Found</h3>
        <p className="text-sm text-slate-500 mt-1 mb-6">
          Create your first promotional banner to display inside the mobile applications.
        </p>
        <button
          onClick={onCreate}
